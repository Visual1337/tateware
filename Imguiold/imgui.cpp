...
bool ImGui::FocusableItemRegister(ImGuiWindow* window, ImGuiID id, bool tab_stop)
{
    ...
    // Process keyboard input at this point: TAB/Shift-TAB to tab out of the currently focused global.
...
// Allow last item to be overlapped by a subsequent global. Both may be activated during the same frame before the later one takes priority.
...
// center_y_ratio: 0.0f top of last item, 0.5f vertical center of last item, 1.0f bottom of last global.
...
// You can pass a NULL str_id to use the identifier of the last global.
...
static ImVec2 ImGui::NavCalcPreferredRefPos()
{
    ...
    {
        // When navigation is active and mouse is disabled, decide on an arbitrary position around the bottom left of the currently navigated global.
